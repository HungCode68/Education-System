...
public class LessonController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('LMS_LESSON_CREATE')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('LMS_LESSON_UPDATE')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority('LMS_LESSON_DELETE')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAuthority('LMS_LESSON_VIEW')")
